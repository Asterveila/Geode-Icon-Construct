...
You can use MoreIcons' "Load from Traditional Icon Packs" setting to load your traditional icons via the mod and use them here, though!
...
- **Ball Rolling Preview**: Quickly preview how your Ball icons are gonna look in-game directly in the mod's Popup! In case you're worried if the circle at the middle is gonna be painful to look at when spinning because of it not being properly centered. Allows for controlling the ball's rotation speed too!
...
- **Easy Mobile Offset Controls**: Don't wanna be constantly typing out numbers to change your icon's offset if you're on mobile? No worries, Icon Construct provides you with easy to use mobile controls! Simply click on the arrows next to the offset inputs to nudge them up/down by 1 unit, and view your changes happen in real time!
- **Trail Previewing**: Wanna see the position your trail will come out of for gamemodes like Cube, Ship, or Swing? You can! Icon Construct allows you to preview the look of trails in your gamemodes! Preview your basic trail on Cube, Ship, etc, and preview your Wave Trail too for Wave Icons!

## Credits
- [hiimjasmine00](https://github.com/hiimjasmine00): Internal code improvements/optimizations, updated to new More Icons API. Added Automatic Updating. Creator of the More Icons mod.
